...
getwd()
setwd("C:/Users/Deep/Desktop/Data Scientist/Project/Project 1")
...
a = table(df_train$target)/length(df_train$target)
a*100
...
#Observation:- We are having a unbalanced data, where 89.95% of the data is no. of customers who will not make a transaction 
#& 10.049 % of  the data are those who will make a transaction.
...
#Observation:-We can observed that the top important features are var_12, var_26, var_22,v var_174, var_198 and so on based on Mean decrease gini index.
